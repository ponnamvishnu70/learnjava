...
public class JavaBasedConfigExample {
	...
	//If there are multiple beans of same type .you can make one of as primary so that spring container know what is default bean
	@Primary
	...
	@Bean//the bean id is name of the method
	@Scope("prototype")//default is singleton
